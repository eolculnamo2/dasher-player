...
var getBugErrorMessage = (message) =>
...
var randomHashCache = /* @__PURE__ */ globalValue(
...
var defaultValueCache = /* @__PURE__ */ globalValue(
...
var match = /* @__PURE__ */ dual(2, (self, { onLeft, onRight }) =>
...
var number2 = /* @__PURE__ */ make4((self, that) => (self < that ? -1 : 1));
...
var isNone2 = isNone;
var isSome2 = isSome;
var match2 = /* @__PURE__ */ dual(2, (self, { onNone, onSome }) =>
...
var reduceRight = /* @__PURE__ */ dual(3, (self, b, f) =>
...
var emptyArray = [];
var getEquivalence2 = (isEquivalent) =>
  make3(
    (self, that) =>
      self.length === that.length &&
      toReadonlyArray(self).every((value, i) => isEquivalent(value, unsafeGet4(that, i))),
  );
...
var get4 = /* @__PURE__ */ dual(2, (self, index) =>
  index < 0 || index >= self.length ? none2() : some2(unsafeGet4(self, index)),
);
var unsafeFromArray = (self) =>
  self.length === 0
    ? empty4()
    : self.length === 1
      ? of2(self[0])
  ...
  switch (self.backing._tag) {
    ...
    case "IConcat": {
      return index < self.left.length
        ? unsafeGet4(self.left, index)
        : unsafeGet4(self.right, index - self.left.length);
    }
    case "ISlice": {
...
var lessThanOrEqualTo = /* @__PURE__ */ dual(2, (self, that) =>
  matchWith(self, that, {
    onMillis: (self2, that2) => self2 <= that2,
    onNanos: (self2, that2) => self2 <= that2,
  }),
);
var greaterThanOrEqualTo = /* @__PURE__ */ dual(2, (self, that) =>
  matchWith(self, that, {
    onMillis: (self2, that2) => self2 >= that2,
    onNanos: (self2, that2) => self2 >= that2,
  }),
...
class EmptyNode {
  ...
  modify(edit, _shift, f, hash2, key, size) {
    const v = f(none2());
    if (isNone2(v)) return new EmptyNode();
    ++size.value;
...
var applyCont = (cont) =>
  cont ? visitLazyChildren(cont[0], cont[1], cont[2], cont[3], cont[4]) : none2();
...
var map3 = /* @__PURE__ */ dual(2, (self, f) =>
  reduce2(self, empty5(), (map4, value, key) => set(map4, key, f(value, key))),
);
var forEach = /* @__PURE__ */ dual(2, (self, f) =>
  reduce2(self, undefined, (_, value, key) => f(value, key)),
);
...
var add3 = /* @__PURE__ */ dual(2, (self, value) =>
  self._keyMap._editable
    ? (set(value, true)(self._keyMap), self)
    : makeImpl2(set(value, true)(self._keyMap)),
);
var remove3 = /* @__PURE__ */ dual(2, (self, value) =>
  self._keyMap._editable
    ? (remove2(value)(self._keyMap), self)
    : makeImpl2(remove2(value)(self._keyMap)),
);
var difference2 = /* @__PURE__ */ dual(2, (self, that) =>
  mutate2(self, (set2) => {
...
var reduce3 = /* @__PURE__ */ dual(3, (self, zero2, f) =>
  reduce2(self._keyMap, zero2, (z, _, a) => f(z, a)),
);
...
class Runtime {
  ...
  [symbol]() {
    return cached(
      this,
      string(`${FiberIdSymbolKey}-${this._tag}-${this.id}-${this.startTimeMillis}`),
    );
  }
  [symbol2](that) {
    return (
...
class Composite {
  ...
  [symbol]() {
    return pipe(
      string(`${FiberIdSymbolKey}-${this._tag}`),
      combine(hash(this.left)),
      combine(hash(this.right)),
      cached(this),
    );
  }
  [symbol2](that) {
...
var _fiberCounter = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/Fiber/Id/_fiberCounter"),
  () => make11(0),
);
var threadName = (self) => {
...
var make15 = (active2, enabled2) =>
  (active2 & BIT_MASK) + ((enabled2 & active2 & BIT_MASK) << BIT_SHIFT);
...
var patch4 = /* @__PURE__ */ dual(
  2,
  (self, patch5) =>
    (self & (invert(active(patch5)) | enabled(patch5))) | (active(patch5) & enabled(patch5)),
);
...
var flatten2 = (self) => {
  ...
  let updated = empty9();
  while (true) {
    const [parallel, sequential] = reduce6(
      current,
      [parallelCollectionEmpty(), empty9()],
      ([parallel2, sequential2], blockedRequest) => {
...
var makeEntry = (options) =>
  new EntryImpl(options.request, options.result, options.listeners, options.ownerId, options.state);
var RequestBlockParallelTypeId = /* @__PURE__ */ Symbol.for(
...
var parallelCollectionAdd = (self, blockedRequest) =>
  new ParallelImpl(
    modifyAt2(self.map, blockedRequest.dataSource, (_) =>
      orElseSome(map(_, append2(blockedRequest.blockedRequest)), () =>
        of2(blockedRequest.blockedRequest),
      ),
    ),
  );
var parallelCollectionCombine = (self, that) =>
  new ParallelImpl(
    reduce5(self.map, that.map, (map6, value, key) =>
      set3(
        map6,
        key,
        match2(get7(map6, key), {
          onNone: () => value,
...
var parallelCollectionToSequentialCollection = (self) =>
  sequentialCollectionMake(map5(self.map, (x) => of2(x)));
var SequentialCollectionTypeId = /* @__PURE__ */ Symbol.for(
...
var sequentialCollectionCombine = (self, that) =>
  new SequentialImpl(
    reduce5(that.map, self.map, (map6, value, key) =>
      set3(
        map6,
        key,
        match2(get7(map6, key), {
...
var failures = (self) =>
  reverse2(
    reduce7(self, empty4(), (list, cause) =>
      cause._tag === OP_FAIL ? some2(pipe(list, prepend2(cause.error))) : none2(),
    ),
  );
var defects = (self) =>
  reverse2(
    reduce7(self, empty4(), (list, cause) =>
      cause._tag === OP_DIE ? some2(pipe(list, prepend2(cause.defect))) : none2(),
    ),
  );
var interruptors = (self) =>
  reduce7(self, empty7(), (set4, cause) =>
    cause._tag === OP_INTERRUPT ? some2(pipe(set4, add4(cause.fiberId))) : none2(),
  );
var failureOption = (self) =>
  find(self, (cause) => (cause._tag === OP_FAIL ? some2(cause.error) : none2()));
...
var interruptOption = (self) =>
  find(self, (cause) => (cause._tag === OP_INTERRUPT ? some2(cause.fiberId) : none2()));
var keepDefects = (self) =>
  match4(self, {
    onEmpty: none2(),
    onFail: () => none2(),
...
var keepDefectsAndElectFailures = (self) =>
  match4(self, {
    onEmpty: none2(),
...
var causeEquals = (left3, right3) => {
  ...
  while (isNonEmpty(leftStack) && isNonEmpty(rightStack)) {
    const [leftParallel, leftSequential] = pipe(
      ...
      reduce7([empty7(), empty4()], ([parallel2, sequential2], cause) => {
...
var flattenCauseLoop = (causes, flattened) => {
  while (true) {
    const [parallel2, sequential2] = pipe(
      causes,
      reduce([empty7(), empty4()], ([parallel3, sequential3], cause) => {
        const [par2, seq2] = evaluateCause(cause);
...
var acquireUseRelease = /* @__PURE__ */ dual(3, (acquire, use, release) =>
  uninterruptibleMask((restore) =>
    flatMap7(acquire, (a) =>
      flatMap7(exit(suspend(() => restore(use(a)))), (exit) => {
...
var asyncInterrupt = (register, blockingOn = none4) =>
...
var catchAll = /* @__PURE__ */ dual(2, (self, f) =>
  matchEffect(self, {
    onFailure: f,
    onSuccess: succeed,
  }),
);
var catchIf = /* @__PURE__ */ dual(3, (self, predicate, f) =>
...
var catchSome = /* @__PURE__ */ dual(2, (self, pf) =>
  catchAllCause(self, (cause) => {
    const either2 = failureOrCause(cause);
    switch (either2._tag) {
      case "Left":
...
var checkInterruptible = (f) =>
  withFiberRuntime((_, status) => f(interruption(status.runtimeFlags)));
...
var die2 = (defect) =>
  isObject(defect) && !(spanSymbol in defect)
    ? withFiberRuntime((fiber) => failCause(die(capture(defect, currentSpanFromFiber(fiber)))))
...
var fail2 = (error) =>
  isObject(error) && !(spanSymbol in error)
    ? withFiberRuntime((fiber) => failCause(fail(capture(error, currentSpanFromFiber(fiber)))))
  ...
  flatMap7(self, (a) => {
    ...
    if (isEffect(b)) {
      ...
      return unsafeAsync((resume) => {
        b.then(
          (a2) => resume(succeed(a2)),
          (e) =>
            resume(fail2(new UnknownException(e, "An unknown error occurred in Effect.andThen"))),
        );
      });
    }
    return succeed(b);
...
var forEachSequential = /* @__PURE__ */ dual(2, (self, f) =>
  suspend(() => {
...
var forEachSequentialDiscard = /* @__PURE__ */ dual(2, (self, f) =>
  suspend(() => {
    const arr = fromIterable(self);
    let i = 0;
    return whileLoop({
...
var if_ = /* @__PURE__ */ dual(
  (args) => typeof args[0] === "boolean" || isEffect(args[0]),
  (self, options) =>
    isEffect(self)
      ? flatMap7(self, (b) => (b ? options.onTrue() : options.onFalse()))
      : self
        ? options.onTrue()
        : options.onFalse(),
);
  ...
  custom(f, function () {
    ...
    effect.effect_instruction_i1 = (oldFlags) =>
      interruption(oldFlags)
        ? internalCall(() => this.effect_instruction_i0(interruptible2))
        : internalCall(() => this.effect_instruction_i0(uninterruptible));
    return effect;
  });
var intoDeferred = /* @__PURE__ */ dual(2, (self, deferred) =>
  uninterruptibleMask((restore) =>
    flatMap7(exit(restore(self)), (exit2) => deferredDone(deferred, exit2)),
  ),
);
...
var onError = /* @__PURE__ */ dual(2, (self, cleanup) =>
  onExit(self, (exit2) => (exitIsSuccess(exit2) ? void_ : cleanup(exit2.effect_instruction_i0))),
);
var onExit = /* @__PURE__ */ dual(2, (self, cleanup) =>
  uninterruptibleMask((restore) =>
...
var onInterrupt = /* @__PURE__ */ dual(2, (self, cleanup) =>
  onExit(
    self,
    exitMatch({
      onFailure: (cause) =>
...
var orDieWith = /* @__PURE__ */ dual(2, (self, f) =>
  matchEffect(self, {
...
var tap = /* @__PURE__ */ dual(
  (args) =>
    args.length === 3 || (args.length === 2 && !(isObject(args[1]) && "onlyEffect" in args[1])),
  (self, f) =>
    flatMap7(self, (a) => {
      const b = typeof f === "function" ? f(a) : f;
      if (isEffect(b)) {
        ...
        return unsafeAsync((resume) => {
          b.then(
            (_) => resume(succeed(a)),
            (e) =>
              resume(fail2(new UnknownException(e, "An unknown error occurred in Effect.tap"))),
          );
        });
      }
      return succeed(a);
...
var transplant = (f) =>
  withFiberRuntime((state) => {
    ...
    const scope = pipe(
      scopeOverride,
      getOrElse2(() => state.scope()),
    );
    return f(fiberRefLocally(currentForkScopeOverride, some2(scope)));
  });
var attemptOrElse = /* @__PURE__ */ dual(3, (self, that, onSuccess) =>
  matchCauseEffect(self, {
    onFailure: (cause) => {
      const defects2 = defects(cause);
      if (defects2.length > 0) {
...
var whenEffect = /* @__PURE__ */ dual(2, (self, condition) =>
  flatMap7(condition, (b) => {
    if (b) {
...
var withConcurrency = /* @__PURE__ */ dual(2, (self, concurrency) =>
  fiberRefLocally(self, currentConcurrency, concurrency),
);
var withRequestBatching = /* @__PURE__ */ dual(2, (self, requestBatching) =>
...
var withTracerEnabled = /* @__PURE__ */ dual(2, (effect, enabled2) =>
  fiberRefLocally(effect, currentTracerEnabled, enabled2),
);
var withTracerTiming = /* @__PURE__ */ dual(2, (effect, enabled2) =>
  fiberRefLocally(effect, currentTracerTimingEnabled, enabled2),
);
...
var zip2 = /* @__PURE__ */ dual(2, (self, that) =>
  flatMap7(self, (a) => map8(that, (b) => [a, b])),
);
...
var zipWith2 = /* @__PURE__ */ dual(3, (self, that, f) =>
  flatMap7(self, (a) => map8(that, (b) => f(a, b))),
);
var never = /* @__PURE__ */ asyncInterrupt(() => {
  const interval = setInterval(() => {}, 2 ** 31 - 1);
  return sync(() => clearInterval(interval));
});
var interruptFiber = (self) =>
  flatMap7(fiberId, (fiberId2) => pipe(self, interruptAsFiber(fiberId2)));
var interruptAsFiber = /* @__PURE__ */ dual(2, (self, fiberId2) =>
  flatMap7(self.interruptAsFork(fiberId2), () => self.await),
);
var logLevelAll = {
  _tag: "All",
  syslog: 0,
...
var fiberRefSet = /* @__PURE__ */ dual(2, (self, value) =>
  fiberRefModify(self, () => [undefined, value]),
);
var fiberRefModify = /* @__PURE__ */ dual(2, (self, f) =>
  withFiberRuntime((state) => {
...
var fiberRefLocally = /* @__PURE__ */ dual(3, (use, self, value) =>
  acquireUseRelease(
...
var fiberRefLocallyWith = /* @__PURE__ */ dual(3, (use, self, f) =>
  fiberRefGetWith(self, (a) => fiberRefLocally(use, self, f(a))),
);
var fiberRefUnsafeMake = (initial, options) =>
...
var fiberRefUnsafeMakeRuntimeFlags = (initial) =>
  fiberRefUnsafeMakePatch(initial, {
    differ,
    fork: differ.empty,
  });
var currentContext = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentContext"),
  () => fiberRefUnsafeMakeContext(empty2()),
);
var currentSchedulingPriority = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentSchedulingPriority"),
  () => fiberRefUnsafeMake(0),
);
var currentMaxOpsBeforeYield = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentMaxOpsBeforeYield"),
  () => fiberRefUnsafeMake(2048),
);
var currentLogAnnotations = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentLogAnnotation"),
  () => fiberRefUnsafeMake(empty8()),
);
var currentLogLevel = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentLogLevel"),
  () => fiberRefUnsafeMake(logLevelInfo),
);
var currentLogSpan = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentLogSpan"),
  () => fiberRefUnsafeMake(empty9()),
);
var withSchedulingPriority = /* @__PURE__ */ dual(2, (self, scheduler) =>
  fiberRefLocally(self, currentSchedulingPriority, scheduler),
);
var withMaxOpsBeforeYield = /* @__PURE__ */ dual(2, (self, scheduler) =>
  fiberRefLocally(self, currentMaxOpsBeforeYield, scheduler),
);
var currentConcurrency = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentConcurrency"),
  () => fiberRefUnsafeMake("unbounded"),
);
var currentRequestBatching = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentRequestBatching"),
  () => fiberRefUnsafeMake(true),
);
var currentUnhandledErrorLogLevel = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentUnhandledErrorLogLevel"),
  () => fiberRefUnsafeMake(some2(logLevelDebug)),
);
var currentVersionMismatchErrorLogLevel = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/versionMismatchErrorLogLevel"),
  () => fiberRefUnsafeMake(some2(logLevelWarning)),
);
var withUnhandledErrorLogLevel = /* @__PURE__ */ dual(2, (self, level) =>
  fiberRefLocally(self, currentUnhandledErrorLogLevel, level),
);
var currentMetricLabels = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentMetricLabels"),
  () => fiberRefUnsafeMakeReadonlyArray(empty3()),
);
var metricLabels = /* @__PURE__ */ fiberRefGet(currentMetricLabels);
var currentForkScopeOverride = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentForkScopeOverride"),
  () =>
    fiberRefUnsafeMake(none2(), {
      fork: () => none2(),
      join: (parent, _) => parent,
    }),
);
var currentInterruptedCause = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentInterruptedCause"),
  () =>
    fiberRefUnsafeMake(empty16, {
      fork: () => empty16,
      join: (parent, _) => parent,
    }),
);
var currentTracerEnabled = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentTracerEnabled"),
  () => fiberRefUnsafeMake(true),
);
var currentTracerTimingEnabled = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentTracerTiming"),
  () => fiberRefUnsafeMake(true),
);
var currentTracerSpanAnnotations = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentTracerSpanAnnotations"),
  () => fiberRefUnsafeMake(empty8()),
);
var currentTracerSpanLinks = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentTracerSpanLinks"),
  () => fiberRefUnsafeMake(empty4()),
);
...
var InterruptedExceptionTypeId = /* @__PURE__ */ Symbol.for(
...
var IllegalArgumentExceptionTypeId = /* @__PURE__ */ Symbol.for(
...
var InvalidPubSubCapacityExceptionTypeId = /* @__PURE__ */ Symbol.for(
...
var ExceededCapacityExceptionTypeId = /* @__PURE__ */ Symbol.for(
...
var timeoutExceptionFromDuration = (duration) =>
  new TimeoutException(`Operation timed out after '${format2(duration)}'`);
...
var exitCollectAll = (exits, options) =>
...
var exitCollectAllInternal = (exits, combineCauses) => {
  ...
  return pipe(
    tailNonEmpty2(list),
    reduce(pipe(headNonEmpty2(list), exitMap(of2)), (accumulator, current) =>
      pipe(
        accumulator,
        exitZipWith(current, {
...
var deferredCompleteWith = /* @__PURE__ */ dual(2, (self, effect) =>
  sync(() => {
    const state = get6(self.state);
    switch (state._tag) {
      case OP_STATE_DONE: {
...
var deferredFailCause = /* @__PURE__ */ dual(2, (self, cause) =>
  deferredCompleteWith(self, failCause(cause)),
);
var deferredInterrupt = (self) =>
  flatMap7(fiberId, (fiberId2) => deferredCompleteWith(self, interruptWith(fiberId2)));
var deferredSucceed = /* @__PURE__ */ dual(2, (self, value) =>
...
var deferredInterruptJoiner = (self, joiner) =>
  sync(() => {
    const state = get6(self.state);
    if (state._tag === OP_STATE_PENDING) {
...
var provideContext = /* @__PURE__ */ dual(2, (self, context2) =>
  fiberRefLocally(currentContext, context2)(self),
);
var provideSomeContext = /* @__PURE__ */ dual(2, (self, context2) =>
  fiberRefLocallyWith(currentContext, (parent) => merge2(parent, context2))(self),
);
var mapInputContext = /* @__PURE__ */ dual(2, (self, f) =>
  contextWithEffect((context2) => provideContext(self, f(context2))),
);
var filterEffectOrElse = /* @__PURE__ */ dual(2, (self, options) =>
  flatMap7(self, (a) =>
    flatMap7(options.predicate(a), (pass) => (pass ? succeed(a) : options.orElse(a))),
  ),
);
var filterEffectOrFail = /* @__PURE__ */ dual(2, (self, options) =>
    ...
    switch (patch7._tag) {
      ...
      case "Unnested": {
        ...
        if (containsName) {
          ...
          return left2(
            MissingData(output, `Expected ${patch7.name} to be in path in ConfigProvider#unnested`),
          );
        }
        break;
      }
...
var fromFlat = (flat) =>
  make20({
    load: (config) =>
      flatMap7(fromFlatLoop(flat, empty3(), config, false), (chunk) =>
        match2(head(chunk), {
          onNone: () =>
            fail2(MissingData(empty3(), `Expected a single value having structure: ${config}`)),
          onSome: succeed,
        }),
      ),
    flattened: flat,
...
var fromEnv = (options) => {
  ...
  const load = (path, primitive, split = true) => {
    ...
    return pipe(
      valueOpt,
      mapError(() => MissingData(path, `Expected ${pathString} to exist in the process context`)),
      flatMap7((value) => parsePrimitive(value, path, primitive, seqDelim, split)),
    );
  };
...
var extend = (leftDef, rightDef, left3, right3) => {
  const leftPad = unfold(left3.length, (index) =>
    index >= right3.length ? none2() : some2([leftDef(index), index + 1]),
  );
  const rightPad = unfold(right3.length, (index) =>
    index >= left3.length ? none2() : some2([rightDef(index), index + 1]),
  );
...
var fromFlatLoop = (flat, prefix, config, split) => {
  ...
  switch (op._tag) {
        ...
        catchAll((error1) => {
          if (op.condition(error1)) {
            return pipe(
              ...
              catchAll((error2) => fail2(Or(error1, error2))),
            );
          }
          return fail2(error1);
        }),
    ...
    case OP_MAP_OR_FAIL: {
      return suspend(() =>
        pipe(
          ...
          flatMap7(
            forEachSequential((a) =>
              pipe(op.mapOrFail(a), mapError(prefixed(appendConfigPath(prefix, op.original)))),
            ),
          ),
        ),
      );
    ...
    case OP_PRIMITIVE: {
      return pipe(
        patch5(prefix, flat.patch),
        flatMap7((prefix2) =>
          pipe(
            flat.load(prefix2, op, split),
            flatMap7((values3) => {
              if (values3.length === 0) {
                const name = pipe(
                  last(prefix2),
    ...
    case OP_SEQUENCE: {
      return pipe(
        patch5(prefix, flat.patch),
        flatMap7((patchedPrefix) =>
          pipe(
            flat.enumerateChildren(patchedPrefix),
            flatMap7(indicesFrom),
            flatMap7((indices) => {
              if (indices.length === 0) {
              ...
              return pipe(
                forEachSequential(indices, (index) =>
                  fromFlatLoop(flat, append(prefix, `[${index}]`), op.config, true),
                ),
                map8((chunkChunk) => {
    ...
    case OP_HASHMAP: {
      return suspend(() =>
        pipe(
          ...
          flatMap7((prefix2) =>
            pipe(
              flat.enumerateChildren(prefix2),
              flatMap7((keys3) => {
                return pipe(
                  keys3,
                  forEachSequential((key) =>
                    fromFlatLoop(flat, concat(prefix2, of(key)), op.valueConfig, split),
                  ),
                  map8((matrix) => {
                    if (matrix.length === 0) {
                      return of(empty8());
                    ...
                    return pipe(
                      transpose(matrix),
                      map2((values3) => fromIterable6(zip(fromIterable(keys3), values3))),
                    );
                  }),
                );
              }),
              ...
              flatMap7((right3) => {
                ...
                if (isRight2(left3) && isRight2(right3)) {
                  ...
                  const [lefts, rights] = extend(
                    fail3,
                    fail3,
                    pipe(left3.right, map2(right2)),
                    pipe(right3.right, map2(right2)),
                  );
                  return pipe(
                    lefts,
                    zip(rights),
                    forEachSequential(([left4, right4]) =>
                      pipe(
                        zip2(left4, right4),
                        map8(([left5, right5]) => op.zip(left5, right5)),
                      ),
                    ),
                  );
                }
...
var fromFlatLoopFail = (prefix, path) => (index) =>
  left2(
    MissingData(
      prefix,
...
var parseQuotedIndex = (str) => {
  ...
  if (match6 !== null) {
    ...
    return pipe(
      matchedIndex !== undefined && matchedIndex.length > 0 ? some2(matchedIndex) : none2(),
      ...
      flatMap7((buffer) => {
        ...
        return pipe(
          ...
          forEachSequentialDiscard((n) =>
            pipe(
              nextIntBounded(n),
              map8((k) => swap(buffer, n - 1, k)),
            ),
          ),
          as(fromIterable2(buffer)),
        );
      }),
    ),
  );
...
var nativeTracer = /* @__PURE__ */ make22({
  span: (name, parent, context2, links, startTime, kind) =>
    new NativeSpan(name, parent, context2, links, startTime, kind),
  context: (f) => f(),
});
...
var liveServices = /* @__PURE__ */ pipe(
  /* @__PURE__ */ empty2(),
  /* @__PURE__ */ add2(clockTag, /* @__PURE__ */ make18()),
  /* @__PURE__ */ add2(consoleTag, defaultConsole),
  /* @__PURE__ */ add2(randomTag, /* @__PURE__ */ make21(/* @__PURE__ */ Math.random())),
  /* @__PURE__ */ add2(configProviderTag, /* @__PURE__ */ fromEnv()),
  /* @__PURE__ */ add2(tracerTag, nativeTracer),
);
var currentServices = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/DefaultServices/currentServices"),
...
var withClock = /* @__PURE__ */ dual(2, (effect, c) =>
  fiberRefLocallyWith(currentServices, add2(clockTag, c))(effect),
);
var withConfigProvider = /* @__PURE__ */ dual(2, (self, provider) =>
  fiberRefLocallyWith(currentServices, add2(configProviderTag, provider))(self),
);
var configProviderWith = (f) =>
  defaultServicesWith((services) => f(services.unsafeMap.get(configProviderTag.key)));
var randomWith = (f) => defaultServicesWith((services) => f(services.unsafeMap.get(randomTag.key)));
var withRandom = /* @__PURE__ */ dual(2, (effect, value) =>
  fiberRefLocallyWith(currentServices, add2(randomTag, value))(effect),
);
var tracerWith = (f) => defaultServicesWith((services) => f(services.unsafeMap.get(tracerTag.key)));
var withTracer = /* @__PURE__ */ dual(2, (effect, value) =>
  fiberRefLocallyWith(currentServices, add2(tracerTag, value))(effect),
);
...
var setAll = (self) =>
  forEachSequentialDiscard(fiberRefs(self), (fiberRef) =>
    fiberRefSet(fiberRef, getOrDefault(self, fiberRef)),
  );
...
var getOrDefault = /* @__PURE__ */ dual(2, (self, fiberRef) =>
  pipe(
    get8(self, fiberRef),
    getOrElse2(() => fiberRef.initial),
  ),
);
var updateAs = /* @__PURE__ */ dual(2, (self, { fiberId: fiberId2, fiberRef, value }) => {
...
var updateManyAs = /* @__PURE__ */ dual(2, (self, { entries: entries2, forkAs: forkAs2 }) => {
  if (self.locals.size === 0) {
...
class Running {
  ...
  [symbol]() {
    return pipe(
      ...
      combine(hash(this._tag)),
      combine(hash(this.runtimeFlags)),
      cached(this),
    );
  }
  [symbol2](that) {
...
var Order2 = /* @__PURE__ */ pipe(
  Order,
  /* @__PURE__ */ mapInput2((level) => level.ordinal),
);
...
var provideContext2 = /* @__PURE__ */ dual(2, (self, provided) =>
  updateContext(self, merge2(provided)),
);
class MaxOpsBeforeYield
  extends /* @__PURE__ */ Reference2()("effect/Micro/currentMaxOpsBeforeYield", {
    defaultValue: () => 2048,
  }) {}
class CurrentScheduler
  extends /* @__PURE__ */ Reference2()("effect/Micro/currentScheduler", {
...
var onExit2 = /* @__PURE__ */ dual(2, (self, f) =>
  uninterruptibleMask2((restore) =>
    matchCauseEffect2(restore(self), {
...
var defaultScheduler = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/Scheduler/defaultScheduler"),
...
var currentScheduler = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentScheduler"),
  () => fiberRefUnsafeMake(defaultScheduler),
);
var withScheduler = /* @__PURE__ */ dual(2, (self, scheduler) =>
  fiberRefLocally(self, currentScheduler, scheduler),
);

// node_modules/effect/dist/esm/internal/completedRequestMap.js
var currentRequestMap = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentRequestMap"),
...
var match7 = (concurrency, sequential4, unbounded, bounded) => {
  switch (concurrency) {
    ...
    case "unbounded":
      return unbounded();
    case "inherit":
      return fiberRefGetWith(currentConcurrency, (concurrency2) =>
        concurrency2 === "unbounded"
          ? unbounded()
          : concurrency2 > 1
            ? bounded(concurrency2)
            : sequential4(),
      );
    default:
...
var matchSimple = (concurrency, sequential4, concurrent) => {
  switch (concurrency) {
    ...
    case "inherit":
      return fiberRefGetWith(currentConcurrency, (concurrency2) =>
        concurrency2 === "unbounded" || concurrency2 > 1 ? concurrent() : sequential4(),
      );
    default:
...
var annotateLogs = /* @__PURE__ */ dual(
  ...
  function () {
    ...
    return fiberRefLocallyWith(
      ...
      typeof args2[1] === "string"
        ? set3(args2[1], args2[2])
        : (annotations) =>
            Object.entries(args2[1]).reduce(
              (acc, [key, value]) => set3(acc, key, value),
              annotations,
            ),
    );
  },
    ...
    try {
      ...
      return fail2(
        onFailure
          ...
          : new UnknownException(error, "An unknown error occurred in Effect.try"),
      );
    }
  });
};
var _catch = /* @__PURE__ */ dual(3, (self, tag, options) =>
  catchAll(self, (e) => {
...
var catchAllDefect = /* @__PURE__ */ dual(2, (self, f) =>
  catchAllCause(self, (cause) => {
...
var catchSomeCause = /* @__PURE__ */ dual(2, (self, f) =>
  matchCauseEffect(self, {
    onFailure: (cause) => {
...
var catchSomeDefect = /* @__PURE__ */ dual(2, (self, pf) =>
  catchAllCause(self, (cause) => {
    const option = find(cause, (_) => (isDieType(_) ? some2(_) : none2()));
    switch (option._tag) {
      case "None": {
...
var allowInterrupt = /* @__PURE__ */ descriptorWith((descriptor) =>
  size3(descriptor.interruptors) > 0 ? interrupt2 : void_,
);
var descriptor = /* @__PURE__ */ descriptorWith(succeed);
var diffFiberRefs = (self) => summarized(self, fiberRefs2, diff5);
var diffFiberRefsAndRuntimeFlags = (self) =>
  summarized(self, zip2(fiberRefs2, runtimeFlags), ([refs, flags], [refsNew, flagsNew]) => [
    diff5(refs, refsNew),
    diff4(flags, flagsNew),
  ]);
var Do = /* @__PURE__ */ succeed({});
var bind2 = /* @__PURE__ */ bind(map8, flatMap7);
var bindTo2 = /* @__PURE__ */ bindTo(map8);
var let_2 = /* @__PURE__ */ let_(map8);
var dropUntil = /* @__PURE__ */ dual(2, (elements, predicate) =>
  suspend(() => {
...
var dropWhile = /* @__PURE__ */ dual(2, (elements, predicate) =>
  suspend(() => {
    const iterator = elements[Symbol.iterator]();
    const builder = [];
    let next;
    ...
    while ((next = iterator.next()) && !next.done) {
      const a = next.value;
      const index = i++;
      dropping = flatMap7(dropping, (d) =>
        map8(d ? predicate(a, index) : succeed(false), (b) => {
          if (!b) {
            builder.push(a);
          }
          return b;
...
var filterMap3 = /* @__PURE__ */ dual(2, (elements, pf) =>
  map8(forEachSequential(elements, identity), filterMap(pf)),
);
var filterOrDie = /* @__PURE__ */ dual(3, (self, predicate, orDieWith2) =>
  filterOrElse(self, predicate, (a) => dieSync(() => orDieWith2(a))),
);
var filterOrDieMessage = /* @__PURE__ */ dual(3, (self, predicate, message) =>
  filterOrElse(self, predicate, () => dieMessage(message)),
);
var filterOrElse = /* @__PURE__ */ dual(3, (self, predicate, orElse2) =>
  flatMap7(self, (a) => (predicate(a) ? succeed(a) : orElse2(a))),
);
var liftPredicate = /* @__PURE__ */ dual(3, (self, predicate, orFailWith) =>
  suspend(() => (predicate(self) ? succeed(self) : fail2(orFailWith(self)))),
);
  ...
  (self, predicate, orFailWith) =>
    filterOrElse(self, predicate, (a) =>
      orFailWith === undefined
        ? fail2(new NoSuchElementException())
        : failSync(() => orFailWith(a)),
    ),
);
var findFirst3 = /* @__PURE__ */ dual(2, (elements, predicate) =>
  suspend(() => {
    const iterator = elements[Symbol.iterator]();
...
var findLoop = (iterator, index, f, value) =>
  flatMap7(f(value, index), (result) => {
    if (result) {
...
var firstSuccessOf = (effects) =>
  suspend(() => {
    ...
    return pipe(
      tailNonEmpty2(list),
      reduce(headNonEmpty2(list), (left3, right3) => orElse(left3, () => right3)),
    );
  });
var flipWith = /* @__PURE__ */ dual(2, (self, f) => flip(f(flip(self))));
var match8 = /* @__PURE__ */ dual(2, (self, options) =>
  matchEffect(self, {
    onFailure: (e) => succeed(options.onFailure(e)),
    onSuccess: (a) => succeed(options.onSuccess(a)),
  }),
);
var every4 = /* @__PURE__ */ dual(2, (elements, predicate) =>
  suspend(() => forAllLoop(elements[Symbol.iterator](), 0, predicate)),
);
var forAllLoop = (iterator, index, f) => {
  const next = iterator.next();
  return next.done
    ? succeed(true)
    : flatMap7(f(next.value, index), (b) => (b ? forAllLoop(iterator, index + 1, f) : succeed(b)));
};
var forever = (self) => {
  const loop = flatMap7(
    flatMap7(self, () => yieldNow()),
    () => loop,
  );
  return loop;
};
...
var ignoreLogged = (self) =>
  matchCauseEffect(self, {
    onFailure: (cause2) =>
      logDebug(cause2, "An error was silently ignored because it is not anticipated to be useful"),
    onSuccess: () => void_,
  });
var inheritFiberRefs = (childFiberRefs) =>
  updateFiberRefs((parentFiberId, parentFiberRefs) =>
    joinAs2(parentFiberRefs, parentFiberId, childFiberRefs),
  );
var isFailure = (self) =>
  match8(self, {
    onFailure: constTrue,
...
var withLogSpan = /* @__PURE__ */ dual(2, (effect, label) =>
  flatMap7(currentTimeMillis2, (now) =>
    fiberRefLocallyWith(effect, currentLogSpan, prepend3(make26(label, now))),
  ),
);
var logAnnotations = /* @__PURE__ */ fiberRefGet(currentLogAnnotations);
var loop = (initial, options) =>
  options.discard
    ? loopDiscard(initial, options.while, options.step, options.body)
    : map8(loopInternal(initial, options.while, options.step, options.body), fromIterable);
var loopInternal = (initial, cont, inc, body) =>
  suspend(() =>
    cont(initial)
      ? flatMap7(body(initial), (a) =>
          map8(loopInternal(inc(initial), cont, inc, body), prepend3(a)),
        )
      : sync(() => empty9()),
  );
var loopDiscard = (initial, cont, inc, body) =>
  suspend(() =>
    cont(initial)
      ? flatMap7(body(initial), () => loopDiscard(inc(initial), cont, inc, body))
      : void_,
  );
var mapAccum2 = /* @__PURE__ */ dual(3, (elements, initial, f) =>
  suspend(() => {
    const iterator = elements[Symbol.iterator]();
    const builder = [];
    ...
    while (!(next = iterator.next()).done) {
      ...
      result = flatMap7(result, (state) =>
        map8(f(state, value, index), ([z, b]) => {
          builder.push(b);
          return z;
        }),
      );
...
var mapErrorCause = /* @__PURE__ */ dual(2, (self, f) =>
  matchCauseEffect(self, {
        ...
        map8((complete) =>
          zipRight(
            ...
            pipe(
              ...
              flatMap7(([patch8, a]) =>
                as(zip2(patchFiberRefs(patch8[0]), updateRuntimeFlags(patch8[1])), a),
              ),
            ),
          ),
        ),
...
var orElseFail = /* @__PURE__ */ dual(2, (self, evaluate2) =>
  orElse(self, () => failSync(evaluate2)),
);
var orElseSucceed = /* @__PURE__ */ dual(2, (self, evaluate2) =>
  orElse(self, () => sync(evaluate2)),
);
var parallelErrors = (self) =>
  matchCauseEffect(self, {
    onFailure: (cause2) => {
...
var patchFiberRefs = (patch8) =>
  updateFiberRefs((fiberId2, fiberRefs3) => pipe(patch8, patch6(fiberId2, fiberRefs3)));
var promise = (evaluate2) =>
  evaluate2.length >= 1
    ? async_((resolve, signal) => {
        try {
          evaluate2(signal).then(
            (a) => resolve(succeed(a)),
            (e) => resolve(die2(e)),
          );
        } catch (e) {
...
var provideService = /* @__PURE__ */ dual(3, (self, tag, service) =>
  contextWithEffect((env) => provideContext(self, add2(env, tag, service))),
);
var provideServiceEffect = /* @__PURE__ */ dual(3, (self, tag, effect) =>
  contextWithEffect((env) =>
    flatMap7(effect, (service) => provideContext(self, pipe(env, add2(tag, service)))),
  ),
);
var random2 = /* @__PURE__ */ randomWith(succeed);
var reduce8 = /* @__PURE__ */ dual(3, (elements, zero2, f) =>
  fromIterable(elements).reduce((acc, el, i) => flatMap7(acc, (a) => f(a, el, i)), succeed(zero2)),
);
var reduceRight2 = /* @__PURE__ */ dual(3, (elements, zero2, f) =>
  fromIterable(elements).reduceRight(
    (acc, el, i) => flatMap7(acc, (a) => f(el, a, i)),
    succeed(zero2),
  ),
);
var reduceWhile = /* @__PURE__ */ dual(3, (elements, zero2, options) =>
  flatMap7(
    sync(() => elements[Symbol.iterator]()),
    (iterator) => reduceWhileLoop(iterator, 0, zero2, options.while, options.body),
  ),
);
var reduceWhileLoop = (iterator, index, state, predicate, f) => {
  const next = iterator.next();
  if (!next.done && predicate(state)) {
    return flatMap7(f(state, next.value, index), (nextState) =>
...
var repeatNLoop = (self, n) =>
  flatMap7(self, (a) => (n <= 0 ? succeed(a) : zipRight(yieldNow(), repeatNLoop(self, n - 1))));
var sandbox = (self) =>
  matchCauseEffect(self, {
    onFailure: fail2,
    onSuccess: succeed,
...
var summarized = /* @__PURE__ */ dual(3, (self, summary, f) =>
  flatMap7(summary, (start) =>
    flatMap7(self, (value) => map8(summary, (end) => [f(start, end), value])),
  ),
);
var tagMetrics = /* @__PURE__ */ dual(
  (args2) => isEffect(args2[0]),
  function () {
    return labelMetrics(
      arguments[0],
      typeof arguments[1] === "string"
        ? [make27(arguments[1], arguments[2])]
        : Object.entries(arguments[1]).map(([k, v]) => make27(k, v)),
    );
  },
);
var labelMetrics = /* @__PURE__ */ dual(2, (self, labels) =>
  fiberRefLocallyWith(self, currentMetricLabels, (old) => union(old, labels)),
);
var takeUntil = /* @__PURE__ */ dual(2, (elements, predicate) =>
  suspend(() => {
    const iterator = elements[Symbol.iterator]();
    const builder = [];
    let next;
...
var takeWhile = /* @__PURE__ */ dual(2, (elements, predicate) =>
  suspend(() => {
    const iterator = elements[Symbol.iterator]();
    const builder = [];
    let next;
    ...
    while ((next = iterator.next()) && !next.done) {
      const a = next.value;
      const index = i++;
      taking = flatMap7(taking, (taking2) =>
        pipe(
          taking2 ? predicate(a, index) : succeed(false),
          map8((bool) => {
            if (bool) {
              builder.push(a);
            }
...
var tapBoth = /* @__PURE__ */ dual(2, (self, { onFailure, onSuccess }) =>
  matchCauseEffect(self, {
    onFailure: (cause2) => {
...
var tapDefect = /* @__PURE__ */ dual(2, (self, f) =>
  catchAllCause(self, (cause2) =>
    match2(keepDefects(cause2), {
      onNone: () => failCause(cause2),
      onSome: (a) => zipRight(f(a), failCause(cause2)),
    }),
  ),
);
var tapError = /* @__PURE__ */ dual(2, (self, f) =>
  matchCauseEffect(self, {
    onFailure: (cause2) => {
      const either3 = failureOrCause(cause2);
      switch (either3._tag) {
...
var tapErrorCause = /* @__PURE__ */ dual(2, (self, f) =>
  matchCauseEffect(self, {
...
var timedWith = /* @__PURE__ */ dual(2, (self, nanos2) =>
  summarized(self, nanos2, (start, end) => nanos(end - start)),
);
...
var tryPromise = (arg) => {
  ...
  const fail3 = (e) =>
    catcher
      ? failSync(() => catcher(e))
      : fail2(new UnknownException(e, "An unknown error occurred in Effect.tryPromise"));
...
var tryMap = /* @__PURE__ */ dual(2, (self, options) =>
  flatMap7(self, (a) =>
    try_({
      try: () => options.try(a),
      catch: options.catch,
...
var tryMapPromise = /* @__PURE__ */ dual(2, (self, options) =>
  flatMap7(self, (a) =>
    tryPromise({
...
var unless = /* @__PURE__ */ dual(2, (self, condition) =>
  suspend(() => (condition() ? succeedNone : asSome(self))),
);
var unlessEffect = /* @__PURE__ */ dual(2, (self, condition) =>
  flatMap7(condition, (b) => (b ? succeedNone : asSome(self))),
);
var unsandbox = (self) => mapErrorCause(self, flatten3);
var updateFiberRefs = (f) =>
  withFiberRuntime((state) => {
    state.setFiberRefs(f(state.id(), state.getFiberRefs()));
    return void_;
  });
var updateService = /* @__PURE__ */ dual(3, (self, tag, f) =>
  mapInputContext(self, (context2) => add2(context2, tag, f(unsafeGet2(context2, tag)))),
);
var when = /* @__PURE__ */ dual(2, (self, condition) =>
  suspend(() => (condition() ? map8(self, some2) : succeed(none2()))),
);
var whenFiberRef = /* @__PURE__ */ dual(3, (self, fiberRef, predicate) =>
  flatMap7(fiberRefGet(fiberRef), (s) =>
    predicate(s) ? map8(self, (a) => [s, some2(a)]) : succeed([s, none2()]),
  ),
);
var whenRef = /* @__PURE__ */ dual(3, (self, ref, predicate) =>
  flatMap7(get11(ref), (s) =>
    predicate(s) ? map8(self, (a) => [s, some2(a)]) : succeed([s, none2()]),
  ),
);
var withMetric = /* @__PURE__ */ dual(2, (self, metric) => metric(self));
var serviceFunctionEffect =
  (getService, f) =>
  (...args2) =>
    flatMap7(getService, (a) => f(a)(...args2));
var serviceFunction =
  (getService, f) =>
  (...args2) =>
    map8(getService, (a) => f(a)(...args2));
var serviceFunctions = (getService) =>
  new Proxy(
    {},
    {
...
var serviceConstants = (getService) =>
  new Proxy(
    {},
    {
      get(_target, prop, _receiver) {
...
var annotateCurrentSpan = function () {
  const args2 = arguments;
  return ignore(
    flatMap7(currentPropagatedSpan, (span2) =>
      sync(() => {
...
var linkSpanCurrent = function () {
  const args2 = arguments;
  const links = Array.isArray(args2[0])
    ? args2[0]
    : [
        {
          _tag: "SpanLink",
...
var currentSpan = /* @__PURE__ */ flatMap7(/* @__PURE__ */ context(), (context2) => {
  ...
  return span2 !== undefined && span2._tag === "Span"
    ? succeed(span2)
    : fail2(new NoSuchElementException());
});
var currentPropagatedSpan = /* @__PURE__ */ flatMap7(/* @__PURE__ */ context(), (context2) => {
  ...
  return span2._tag === "Some" && span2.value._tag === "Span"
    ? succeed(span2.value)
    : fail2(new NoSuchElementException());
});
var linkSpans = /* @__PURE__ */ dual(
  (args2) => isEffect(args2[0]),
  (self, span2, attributes) =>
    fiberRefLocallyWith(
      self,
...
var filterDisablePropagation = /* @__PURE__ */ flatMap((span2) =>
  get2(span2.context, DisablePropagation)
    ? span2._tag === "Span"
      ? filterDisablePropagation(span2.parent)
      : none2()
    : some2(span2),
);
var unsafeMakeSpan = (fiber, name, options) => {
  const disablePropagation =
    ...
    (options.context && get2(options.context, DisablePropagation));
  const context2 = fiber.getFiberRef(currentContext);
  const parent = options.parent
    ? some2(options.parent)
    : options.root
      ? none2()
      : filterDisablePropagation(getOption2(context2, spanTag));
  let span2;
    ...
    const links =
      linksFromEnv._tag === "Some"
        ? options.links !== undefined
          ? [...toReadonlyArray(linksFromEnv.value), ...(options.links ?? [])]
          : toReadonlyArray(linksFromEnv.value)
        : (options.links ?? empty3());
    span2 = tracer2.span(
      name,
      parent,
      options.context ?? empty2(),
      links,
      timingEnabled ? clock2.unsafeCurrentTimeNanos() : bigint02,
...
var endSpan = (span2, exit2, clock2, timingEnabled) =>
  sync(() => {
    ...
    return suspend(() => {
      const opts =
        typeof options.options === "function"
          ...
          : options.options;
      return withSpan(
        suspend(() => internalCall(() => options.body.apply(this, arguments))),
        opts.name,
        {
          ...opts,
          captureStackTrace,
...
var fromNullable2 = (value) =>
  value == null ? fail2(new NoSuchElementException()) : succeed(value);
var optionFromOptional = (self) =>
  catchAll(map8(self, some2), (error) =>
    isNoSuchElementException(error) ? succeedNone : fail2(error),
  );
...
var globalScope = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberScope/Global"),
  () => new Global(),
);
...
var interruptAllAs = /* @__PURE__ */ dual(
  2,
  /* @__PURE__ */ fnUntraced(function* (fibers, fiberId2) {
...
var format3 =
  ...
  ({ annotations, cause: cause2, date, fiberId: fiberId2, logLevel, message, spans }) => {
...
var exponential = (options) =>
  pipe(
    makeBy(options.count - 1, (i) => options.start * Math.pow(options.factor, i)),
    unsafeFromArray,
    fromIterable7,
  );
...
var counter2 = (name, options) =>
  new MetricKeyImpl(name, counter(options), fromNullable(options?.description));
var histogram2 = (name, boundaries, description) =>
  new MetricKeyImpl(name, histogram(boundaries), fromNullable(description));
var taggedWithLabels = /* @__PURE__ */ dual(2, (self, extraTags) =>
  extraTags.length === 0
    ? self
    : new MetricKeyImpl(self.name, self.keyType, self.description, union(self.tags, extraTags)),
);
...
class FrequencyState {
  ...
  [symbol]() {
    return pipe(
      ...
      combine(array(fromIterable(this.occurrences.entries()))),
      cached(this),
    );
  }
  [symbol2](that) {
    return (
      ...
      arrayEquals(
        fromIterable(this.occurrences.entries()),
        fromIterable(that.occurrences.entries()),
      )
    );
  }
  pipe() {
...
class HistogramState {
  ...
  [symbol]() {
    return pipe(
      ...
      combine(hash(this.buckets)),
      combine(hash(this.count)),
      combine(hash(this.min)),
      combine(hash(this.max)),
      combine(hash(this.sum)),
      cached(this),
    );
  }
  [symbol2](that) {
...
class SummaryState {
  ...
  [symbol]() {
    return pipe(
      ...
      combine(hash(this.error)),
      combine(hash(this.quantiles)),
      combine(hash(this.count)),
      combine(hash(this.min)),
      combine(hash(this.max)),
      combine(hash(this.sum)),
...
var histogram3 = (options) =>
  new HistogramState(options.buckets, options.count, options.min, options.max, options.sum);
var summary2 = (options) =>
  new SummaryState(
    options.error,
    options.quantiles,
    options.count,
...
var globalMetricRegistry = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/Metric/globalMetricRegistry"),
  () => make29(),
);
...
var histogram5 = (name, boundaries, description) =>
  fromMetricKey(histogram2(name, boundaries, description));
var tagged = /* @__PURE__ */ dual(3, (self, key, value) =>
  taggedWithLabels2(self, [make27(key, value)]),
);
var taggedWithLabels2 = /* @__PURE__ */ dual(2, (self, extraTags) => {
  return make30(
    self.keyType,
    (input, extraTags1) => self.unsafeUpdate(input, union(extraTags, extraTags1)),
...
var update4 = /* @__PURE__ */ dual(2, (self, input) =>
  fiberRefGetWith(currentMetricLabels, (tags) => sync(() => self.unsafeUpdate(input, tags))),
);
...
var complete = /* @__PURE__ */ dual(2, (self, result) =>
  fiberRefGetWith(currentRequestMap, (map9) =>
    sync(() => {
      if (map9.has(self)) {
...
var diff7 = (oldValue, newValue) => {
  ...
  const added = pipe(
    newSupervisors,
    difference3(oldSupervisors),
    reduce4(empty22, (patch9, supervisor) =>
      combine8(patch9, {
...
var fiberLifetimes = /* @__PURE__ */ tagged(
  /* @__PURE__ */ histogram5(
    "effect_fiber_lifetimes",
    /* @__PURE__ */ exponential({
      start: 0.5,
      factor: 2,
      count: 35,
    }),
...
var yieldedOpChannel = /* @__PURE__ */ globalValue(
...
var runBlockedRequests = (self) =>
  forEachSequentialDiscard(flatten2(self), (requestsByRequestResolver) =>
    forEachConcurrentDiscard(
      sequentialCollectionToChunk(requestsByRequestResolver),
      ([dataSource, sequential4]) => {
        const map9 = new Map();
        const arr = [];
...
class FiberRuntime extends Class {
  ...
  log(message, cause2, overrideLogLevel) {
    const logLevel = isSome2(overrideLogLevel)
      ...
      case OP_STATEFUL: {
        message.onFiber(
          ...
          this._exitValue !== null
            ? done3
            : suspended2(this.currentRuntimeFlags, this._asyncBlockingOn),
        );
        return EvaluationSignalContinue;
      }
      default: {
  ...
  ["Blocked"](op) {
    ...
    return uninterruptibleMask((restore) =>
      flatMap7(forkDaemon(runRequestBlock(op.effect_instruction_i0)), () =>
...
var currentMinimumLogLevel = /* @__PURE__ */ globalValue(
  "effect/FiberRef/currentMinimumLogLevel",
  () => fiberRefUnsafeMake(fromLiteral("Info")),
);
var loggerWithConsoleLog = (self) =>
  makeLogger((opts) => {
    const services = getOrDefault2(opts.context, currentServices);
    get2(services, consoleTag).unsafe.log(self.log(opts));
  });
var defaultLogger = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/Logger/defaultLogger"),
  () => loggerWithConsoleLog(stringLogger),
);
var tracerLogger = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/Logger/tracerLogger"),
  () =>
    makeLogger(
      ({ annotations, cause: cause2, context: context2, fiberId: fiberId2, logLevel, message }) => {
        const span2 = filterDisablePropagation(
          getOption2(getOrDefault(context2, currentContext), spanTag),
        );
...
var currentLoggers = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentLoggers"),
  () => fiberRefUnsafeMakeHashSet(make10(defaultLogger, tracerLogger)),
);
...
var acquireRelease = /* @__PURE__ */ dual(
  (args2) => isEffect(args2[0]),
  (acquire, release) =>
    uninterruptible(tap(acquire, (a) => addFinalizer((exit2) => release(a, exit2)))),
);
var acquireReleaseInterruptible = /* @__PURE__ */ dual(
  (args2) => isEffect(args2[0]),
  (acquire, release) =>
    ensuring(
      acquire,
      addFinalizer((exit2) => release(exit2)),
    ),
);
var addFinalizer = (finalizer) =>
  withFiberRuntime((runtime2) => {
    const acquireRefs = runtime2.getFiberRefs();
    const acquireFlags = disable2(runtime2.currentRuntimeFlags, Interruption);
    return flatMap7(scope, (scope) =>
      scopeAddFinalizerExit(scope, (exit2) =>
        withFiberRuntime((runtimeFinalizer) => {
          ...
          return ensuring(
            withRuntimeFlags(finalizer(exit2), patchFlags),
            sync(() => {
              runtimeFinalizer.setFiberRefs(
                patch7(inverseRefs, runtimeFinalizer.id(), runtimeFinalizer.getFiberRefs()),
              );
            }),
          );
        }),
...
var existsLoop = (iterator, index, f) => {
  ...
  return flatMap7(f(next.value, index), (b) =>
    b ? succeed(b) : existsLoop(iterator, index + 1, f),
  );
};
var filter4 = /* @__PURE__ */ dual(
  (args2) => isIterable(args2[0]) && !isEffect(args2[0]),
  (elements, predicate, options) => {
    ...
    return matchSimple(
      ...
      () =>
        map8(
          forEach4(
            elements,
            (a, i) => map8(predicate_(a, i), (b) => (b ? some2(a) : none2())),
            options,
          ),
          getSomes,
        ),
...
var allValidate = (effects, reconcile, options) => {
  ...
  return flatMap7(
    forEach4(eitherEffects, identity, {
...
var all2 = (arg, options) => {
  ...
  return options?.discard !== true && reconcile._tag === "Some"
    ? map8(forEach4(effects, identity, options), reconcile.value)
    : forEach4(effects, identity, options);
};
var allWith = (options) => (arg) => all2(arg, options);
var allSuccesses = (elements, options) =>
  map8(
    all2(fromIterable(elements).map(exit), options),
    filterMap((exit2) => (exitIsSuccess(exit2) ? some2(exit2.effect_instruction_i0) : none2())),
  );
...
var forEach4 = /* @__PURE__ */ dual(
  (args2) => isIterable(args2[0]),
  (self, f, options) =>
    withFiberRuntime((r) => {
      const isRequestBatchingEnabled =
        options?.batching === true ||
        (options?.batching === "inherit" && r.getFiberRef(currentRequestBatching));
      if (options?.discard) {
        return match7(
          options.concurrency,
          () =>
...
var forEachParUnbounded = (self, f, batching) =>
  suspend(() => {
...
var forEachConcurrentDiscard = (self, f, batching, processAll, n) =>
  uninterruptibleMask((restore) =>
    transplant((graft) =>
      withFiberRuntime((parent) => {
        ...
        const collectExits = () => {
          const exits = results
            .filter(({ exit: exit2 }) => exit2._tag === "Failure")
            .sort((a, b) => (a.index < b.index ? -1 : a.index === b.index ? 0 : 1))
            .map(({ exit: exit2 }) => exit2);
          if (exits.length === 0) {
            exits.push(exitVoid);
          }
          return exits;
            ...
            const next = () => {
              if (todos.length > 0) {
                ...
                const returnNextElement = () => {
                  const a2 = todos.pop();
                  index = counter6++;
                  return flatMap7(yieldNow(), () =>
                    flatMap7(stepOrExit(restore(f(a2, index))), onRes),
                  );
                };
                const onRes = (res) => {
                  if (todos.length > 0) {
                ...
                fiber.addObserver((wrapped) => {
                  ...
                  if (results.length === target) {
                    ...
                    const requests = residual
                      .map((blocked2) => blocked2.effect_instruction_i0)
                      .reduce(par);
                    resume2(
                      succeed(
                        blocked(
                          ...
                          forEachConcurrentDiscard(
                            [
                              ...
                              ...residual.map((blocked2) => blocked2.effect_instruction_i1),
                            ],
                            (i) => i,
                            batching,
                            true,
        ...
        return asVoid(
          onExit(
            flatten4(restore(join2(processingFiber))),
            exitMatch({
              onFailure: (cause2) => {
                onInterruptSignal();
...
var forEachParN = (self, n, f, batching) =>
  suspend(() => {
    const as2 = fromIterable(self);
    const array3 = new Array(as2.length);
...
var fork = (self) =>
  withFiberRuntime((state, status) => succeed(unsafeFork(self, state, status.runtimeFlags)));
var forkDaemon = (self) => forkWithScopeOverride(self, globalScope);
var forkWithErrorHandler = /* @__PURE__ */ dual(2, (self, handler) =>
  fork(
    onError(self, (cause2) => {
      const either3 = failureOrCause(cause2);
      switch (either3._tag) {
  ...
  const parentScope =
    overrideScope !== null
      ...
      : pipe(
          ...
          getOrElse2(() => parentFiber.scope()),
        );
  parentScope.add(parentRuntimeFlags, childFiber);
  return childFiber;
};
var forkWithScopeOverride = (self, scopeOverride) =>
  withFiberRuntime((parentFiber, parentStatus) =>
    succeed(unsafeFork(self, parentFiber, parentStatus.runtimeFlags, scopeOverride)),
  );
var mergeAll3 = /* @__PURE__ */ dual(
  (args2) => isFunction2(args2[2]),
  (elements, zero2, f, options) =>
    matchSimple(
      options?.concurrency,
      () =>
        fromIterable(elements).reduce(
          (acc, a, i) => zipWith2(acc, a, (acc2, a2) => f(acc2, a2, i)),
          succeed(zero2),
        ),
      () =>
        flatMap7(make24(zero2), (acc) =>
          flatMap7(
            forEach4(
              elements,
              (effect, i) => flatMap7(effect, (a) => update3(acc, (b) => f(b, a, i))),
              options,
            ),
            () => get11(acc),
          ),
...
var partition3 = /* @__PURE__ */ dual(
  (args2) => isIterable(args2[0]),
  (elements, f, options) =>
    pipe(
      forEach4(elements, (a, i) => either2(f(a, i)), options),
      map8((chunk2) => partitionMap2(chunk2, identity)),
    ),
);
var validateAll = /* @__PURE__ */ dual(
  (args2) => isIterable(args2[0]),
  (elements, f, options) =>
    flatMap7(
      partition3(elements, f, {
        concurrency: options?.concurrency,
        batching: options?.batching,
        concurrentFinalizers: options?.concurrentFinalizers,
      }),
...
var raceAll = (all3) =>
  withFiberRuntime((state, status) =>
    async_((resume2) => {
      ...
      for (const self of all3) {
        ...
        fiber.addObserver((exit2) => {
          ...
          if (latch && fibers.size === 0) {
            resume2(
              winner ? zipRight(inheritAll(winner), winner.unsafePoll()) : failCause(failures2),
            );
          }
        });
        if (winner) break;
      ...
      if (empty23) {
        return resume2(
          dieSync(() => new IllegalArgumentException(`Received an empty collection of effects`)),
        );
      }
      latch = true;
...
var reduceEffect = /* @__PURE__ */ dual(
  (args2) => isIterable(args2[0]) && !isEffect(args2[0]),
  (elements, zero2, f, options) =>
    matchSimple(
      options?.concurrency,
...
var parallelFinalizers = (self) =>
  contextWithEffect((context2) =>
    match2(getOption2(context2, scopeTag), {
      onNone: () => self,
      onSome: (scope) => {
...
var parallelNFinalizers = (parallelism) => (self) =>
  contextWithEffect((context2) =>
    match2(getOption2(context2, scopeTag), {
      onNone: () => self,
      onSome: (scope) => {
        ...
        return flatMap7(scopeFork(scope, parallelN2(parallelism)), (inner) =>
...
var finalizersMaskInternal = (strategy, concurrentFinalizers) => (self) =>
  contextWithEffect((context2) =>
    match2(getOption2(context2, scopeTag), {
...
var scopedWith = (f) =>
  flatMap7(scopeMake(), (scope) => onExit(f(scope), (exit2) => scope.close(exit2)));
var scopedEffect = (effect) => flatMap7(scopeMake(), (scope) => scopeUse(effect, scope));
var sequentialFinalizers = (self) =>
  contextWithEffect((context2) =>
    match2(getOption2(context2, scopeTag), {
      onNone: () => self,
      onSome: (scope) => {
...
var labelMetricsScoped = (labels) =>
  fiberRefLocallyScopedWith(currentMetricLabels, (old) => union(old, labels));
var using = /* @__PURE__ */ dual(2, (self, use) =>
  scopedWith((scope) => flatMap7(scopeExtend(self, scope), use)),
);
var validate = /* @__PURE__ */ dual(
  (args2) => isEffect(args2[1]),
  (self, that, options) => validateWith(self, that, (a, b) => [a, b], options),
);
var validateWith = /* @__PURE__ */ dual(
  (args2) => isEffect(args2[1]),
  (self, that, f, options) =>
    flatten4(
      zipWithOptions(
...
var validateFirst = /* @__PURE__ */ dual(
  (args2) => isIterable(args2[0]),
  (elements, f, options) => flip(forEach4(elements, (a, i) => flip(f(a, i)), options)),
);
var withClockScoped = (c) => fiberRefLocallyScopedWith(currentServices, add2(clockTag, c));
var withRandomScoped = (value) =>
  fiberRefLocallyScopedWith(currentServices, add2(randomTag, value));
var withConfigProviderScoped = (provider) =>
  fiberRefLocallyScopedWith(currentServices, add2(configProviderTag, provider));
var withEarlyRelease = (self) =>
  scopeWith((parent) =>
    flatMap7(scopeFork(parent, sequential2), (child) =>
      pipe(
        self,
        scopeExtend(child),
        map8((value) => [
          fiberIdWith((fiberId2) => scopeClose(child, exitInterrupt(fiberId2))),
          value,
        ]),
      ),
    ),
...
var ScopeImplProto = {
  ...
  close(exit2) {
    return suspend(() => {
      ...
      return isSequential(this.strategy)
        ? pipe(
            forEachSequential(finalizers, (fin) => exit(fin(exit2))),
            flatMap7((results) =>
              pipe(
        ...
        : isParallel(this.strategy)
          ? pipe(
              forEachParUnbounded(finalizers, (fin) => exit(fin(exit2)), false),
              flatMap7((results) =>
                pipe(
                  exitCollectAll(results, {
                    parallel: true,
          ...
          : pipe(
              forEachParN(finalizers, this.strategy.parallelism, (fin) => exit(fin(exit2)), false),
              flatMap7((results) =>
                pipe(
                  exitCollectAll(results, {
                    parallel: true,
...
var scopeExtend = /* @__PURE__ */ dual(2, (effect, scope2) =>
  mapInputContext(effect, merge2(make2(scopeTag, scope2))),
);
var scopeUse = /* @__PURE__ */ dual(2, (effect, scope2) =>
  pipe(
    effect,
    scopeExtend(scope2),
    onExit((exit2) => scope2.close(exit2)),
  ),
);
var fiberRefUnsafeMakeSupervisor = (initial) =>
  fiberRefUnsafeMakePatch(initial, {
    differ: differ2,
    fork: empty22,
  });
var fiberRefLocallyScoped = /* @__PURE__ */ dual(2, (self, value) =>
  asVoid(
    acquireRelease(
      flatMap7(fiberRefGet(self), (oldValue) => as(fiberRefSet(self, value), oldValue)),
      (oldValue) => fiberRefSet(self, oldValue),
    ),
  ),
);
var fiberRefLocallyScopedWith = /* @__PURE__ */ dual(2, (self, f) =>
...
var fiberAll = (fibers) => {
  const _fiberAll = {
    ...
    poll: map8(
      ...
      reduceRight(some2(exitSucceed(new Array())), (optionB, optionA) => {
        switch (optionA._tag) {
          case "None": {
            return none2();
          }
    ...
    interruptAsFork: (fiberId2) =>
      forEachSequentialDiscard(fibers, (fiber) => fiber.interruptAsFork(fiberId2)),
  };
  return _fiberAll;
};
var raceWith = /* @__PURE__ */ dual(3, (self, other, options) =>
  raceFibersWith(self, other, {
    onSelfWin: (winner, loser) =>
      flatMap7(winner.await, (exit2) => {
        switch (exit2._tag) {
          case OP_SUCCESS: {
...
var disconnect = (self) =>
  uninterruptibleMask((restore) =>
    fiberIdWith((fiberId2) =>
      flatMap7(forkDaemon(restore(self)), (fiber) =>
        pipe(
          restore(join2(fiber)),
          onInterrupt(() => pipe(fiber, interruptAsFork(fiberId2))),
        ),
      ),
    ),
  );
var race = /* @__PURE__ */ dual(2, (self, that) =>
  fiberIdWith((parentFiberId) =>
    raceWith(self, that, {
      onSelfDone: (exit2, right3) =>
        exitMatchEffect(exit2, {
          onFailure: (cause2) =>
            pipe(
              join2(right3),
              mapErrorCause((cause22) => parallel(cause2, cause22)),
            ),
          onSuccess: (value) => pipe(right3, interruptAsFiber(parentFiberId), as(value)),
        }),
      onOtherDone: (exit2, left3) =>
        exitMatchEffect(exit2, {
          onFailure: (cause2) =>
            pipe(
              join2(left3),
              mapErrorCause((cause22) => parallel(cause22, cause2)),
            ),
...
var raceFibersWith = /* @__PURE__ */ dual(3, (self, other, options) =>
  withFiberRuntime((parentFiber, parentStatus) => {
    const parentRuntimeFlags = parentStatus.runtimeFlags;
    const raceIndicator = make11(true);
    const leftFiber = unsafeMakeChildFiber(
      self,
      parentFiber,
      parentRuntimeFlags,
      options.selfScope,
    );
    const rightFiber = unsafeMakeChildFiber(
      other,
      parentFiber,
      parentRuntimeFlags,
      options.otherScope,
    ...
    return async_(
      (cb) => {
        leftFiber.addObserver(() =>
          completeRace(leftFiber, rightFiber, options.onSelfWin, raceIndicator, cb),
        );
        rightFiber.addObserver(() =>
          completeRace(rightFiber, leftFiber, options.onOtherWin, raceIndicator, cb),
        );
...
var ensuring = /* @__PURE__ */ dual(2, (self, finalizer) =>
  uninterruptibleMask((restore) =>
    matchCauseEffect(restore(self), {
      onFailure: (cause1) =>
...
var invokeWithInterrupt = (self, entries2, onInterrupt2) =>
  fiberIdWith((id) =>
    ensuring(
      flatMap7(forkDaemon(interruptible2(self)), (processing) =>
        async_((cb) => {
...
var makeSpanScoped = (name, options) => {
  ...
  return uninterruptible(
    withFiberRuntime((fiber) => {
      ...
      return as(
        scopeAddFinalizerExit(scope2, (exit2) => endSpan(span2, exit2, clock_, timingEnabled)),
        span2,
      );
    }),
  );
};
var withTracerScoped = (value) =>
  fiberRefLocallyScopedWith(currentServices, add2(tracerTag, value));
var withSpanScoped = function () {
  ...
  if (dataFirst) {
    const self = arguments[0];
    return flatMap7(makeSpanScoped(name, addSpanStackTrace(options)), (span2) =>
      provideService(self, spanTag, span2),
    );
  }
  return (self) =>
    flatMap7(makeSpanScoped(name, addSpanStackTrace(options)), (span2) =>
      provideService(self, spanTag, span2),
    );
};
...
var intersect3 = /* @__PURE__ */ dual(2, (self, that) =>
  intersectLoop(self.intervals, that.intervals, empty4()),
);
...
class Semaphore {
  ...
  withPermits = (n) => (self) =>
    uninterruptibleMask((restore) =>
      flatMap7(restore(this.take(n)), (permits) => ensuring(restore(self), this.release(permits))),
    );
...
var cached2 = /* @__PURE__ */ dual(2, (self, timeToLive) =>
  map8(cachedInvalidateWithTTL(self, timeToLive), (tuple) => tuple[0]),
);
var cachedInvalidateWithTTL = /* @__PURE__ */ dual(2, (self, timeToLive) => {
  const duration = decode(timeToLive);
  return flatMap7(context(), (env) =>
    map8(makeSynchronized(none2()), (cache) => [
      provideContext(getCachedValue(self, duration, cache), env),
...
var computeCachedValue = (self, timeToLive, start3) => {
  ...
  return pipe(
    deferredMake(),
    tap((deferred) => intoDeferred(self, deferred)),
    map8((deferred) => some2([start3 + timeToLiveMillis, deferred])),
  );
};
var getCachedValue = (self, timeToLive, cache) =>
  uninterruptibleMask((restore) =>
    pipe(
      clockWith3((clock2) => clock2.currentTimeMillis),
      flatMap7((time) =>
        updateSomeAndGetEffectSynchronized(cache, (option2) => {
          switch (option2._tag) {
            case "None": {
      ...
      flatMap7((option2) =>
        isNone2(option2)
          ...
          : restore(deferredAwait(option2.value[1])),
      ),
    ),
  );
var invalidateCache = (cache) => set4(cache, none2());
var ensuringChild = /* @__PURE__ */ dual(2, (self, f) =>
  ensuringChildren(self, (children) => f(fiberAll(children))),
);
var ensuringChildren = /* @__PURE__ */ dual(2, (self, children) =>
  flatMap7(track, (supervisor) =>
    pipe(supervised(self, supervisor), ensuring(flatMap7(supervisor.value, children))),
  ),
);
var forkAll = /* @__PURE__ */ dual(
  (args2) => isIterable(args2[0]),
  (effects, options) =>
    options?.discard
      ? forEachSequentialDiscard(effects, fork)
      : map8(forEachSequential(effects, fork), fiberAll),
);
var forkIn = /* @__PURE__ */ dual(2, (self, scope2) =>
  withFiberRuntime((parent, parentStatus) => {
    ...
    if (scopeImpl.state._tag === "Open") {
      const finalizer = () =>
        fiberIdWith((fiberId2) =>
          equals(fiberId2, fiber.id()) ? void_ : asVoid(interruptFiber(fiber)),
        );
      const key = {};
...
var cachedFunction = (f, eq) => {
  return pipe(
    sync(() => empty21()),
    flatMap7(makeSynchronized),
    map8(
      (ref) => (a) =>
        pipe(
          ref.modifyEffect((map9) => {
            const result = pipe(map9, get12(new Key(a, eq)));
            if (isNone2(result)) {
              return pipe(
                deferredMake(),
                tap((deferred) => pipe(diffFiberRefs(f(a)), intoDeferred(deferred), fork)),
                map8((deferred) => [deferred, pipe(map9, set5(new Key(a, eq), deferred))]),
              );
            }
            return succeed([result.value, map9]);
          }),
          flatMap7(deferredAwait),
          flatMap7(([patch9, b]) => pipe(patchFiberRefs(patch9), as(b))),
        ),
    ),
  );
};
var raceFirst = /* @__PURE__ */ dual(2, (self, that) =>
  pipe(exit(self), race(exit(that)), (effect) => flatten4(effect)),
);
...
var timeoutFail = /* @__PURE__ */ dual(2, (self, { duration, onTimeout }) =>
  flatten4(
    timeoutTo(self, {
...
var timeoutFailCause = /* @__PURE__ */ dual(2, (self, { duration, onTimeout }) =>
  flatten4(
    timeoutTo(self, {
...
var timeoutTo = /* @__PURE__ */ dual(2, (self, { duration, onSuccess, onTimeout }) =>
  fiberIdWith((parentFiberId) =>
    uninterruptibleMask((restore) =>
      raceFibersWith(restore(self), interruptible2(sleep3(duration)), {
        onSelfWin: (winner, loser) =>
          flatMap7(winner.await, (exit2) => {
            if (exit2._tag === "Success") {
              return flatMap7(winner.inheritAll, () =>
                as(interruptAsFiber(loser, parentFiberId), onSuccess(exit2.value)),
              );
            } else {
              return flatMap7(interruptAsFiber(loser, parentFiberId), () =>
                exitFailCause(exit2.cause),
              );
            }
          }),
        onOtherWin: (winner, loser) =>
          flatMap7(winner.await, (exit2) => {
            if (exit2._tag === "Success") {
              return flatMap7(winner.inheritAll, () =>
                as(interruptAsFiber(loser, parentFiberId), onTimeout()),
              );
            } else {
              return flatMap7(interruptAsFiber(loser, parentFiberId), () =>
                exitFailCause(exit2.cause),
...
class SynchronizedImpl extends Class {
  ...
  modifyEffect(f) {
    return this.withLock(
      pipe(
        flatMap7(get10(this.ref), f),
        flatMap7(([b, a]) => as(set4(this.ref, a), b)),
      ),
    );
  }
}
...
var updateSomeAndGetEffectSynchronized = /* @__PURE__ */ dual(2, (self, pf) =>
...
var bindAll = /* @__PURE__ */ dual(
  (args2) => isEffect(args2[0]),
  (self, f, options) =>
    flatMap7(self, (a) => all2(f(a), options).pipe(map8((record) => Object.assign({}, a, record)))),
);
...
var unsafeFork2 = /* @__PURE__ */ makeDual((runtime2, self, options) => {
  ...
  let effect = self;
  if (options?.scope) {
    effect = flatMap7(fork2(options.scope, sequential2), (closeableScope) =>
      zipRight(
        scopeAddFinalizer(
          closeableScope,
          fiberIdWith((id) =>
            equals(id, fiberRuntime.id()) ? void_ : interruptAsFiber(fiberRuntime, id),
          ),
        ),
        onExit(self, (exit2) => close(closeableScope, exit2)),
      ),
    );
  }
...
var unsafeRunCallback = /* @__PURE__ */ makeDual((runtime2, effect, options = {}) => {
  ...
  return (id, cancelOptions) =>
    unsafeRunCallback(runtime2)(pipe(fiberRuntime, interruptAs(id ?? none4)), {
      ...cancelOptions,
...
class FiberFailureImpl extends Error {
  ...
  toString() {
    return (
      "(FiberFailure) " +
      pretty(this[FiberFailureCauseId], {
        renderErrorCause: true,
      })
    );
  }
...
var unsafeRunPromise = /* @__PURE__ */ makeDual((runtime2, effect, options) =>
  unsafeRunPromiseExit(runtime2, effect, options).then((result) => {
    switch (result._tag) {
      case OP_SUCCESS: {
        return result.effect_instruction_i0;
      }
...
var unsafeRunPromiseExit = /* @__PURE__ */ makeDual(
  (runtime2, effect, options) =>
    new Promise((resolve) => {
      const op = fastPath(effect);
      if (op) {
        resolve(op);
...
var runtime2 = () =>
  withFiberRuntime((state, status) =>
    succeed(
      new RuntimeImpl(state.getFiberRef(currentContext), status.runtimeFlags, state.getFiberRefs()),
    ),
  );
...
var asyncEffect = (register) =>
  suspend(() => {
    ...
    return flatMap7(deferredMake(), (deferred) =>
      flatMap7(runtime2(), (runtime3) =>
        uninterruptibleMask((restore) =>
          zipRight(
            fork(
              restore(
                matchCauseEffect(
                  register((cb) => unsafeRunCallback(runtime3)(intoDeferred(cb, deferred))),
                  {
                  ...
                  map8((finalizerRef) => {
                    const resource = uninterruptibleMask((restore) =>
                      pipe(
                        ...
                        flatMap7((innerScope) =>
                          pipe(
                            restore(
                              flatMap7(makeBuilder(layer, innerScope, true), (f) =>
                            ...
                            flatMap7((exit2) => {
                              switch (exit2._tag) {
                                case OP_FAILURE: {
                                  return pipe(
                                    deferredFailCause(deferred, exit2.effect_instruction_i0),
                                    zipRight(scopeClose(innerScope, exit2)),
                                    zipRight(failCause(exit2.effect_instruction_i0)),
                                  );
                                }
                                case OP_SUCCESS: {
                                  return pipe(
                                    set4(finalizerRef, (exit3) =>
                                      pipe(
                                        scopeClose(innerScope, exit3),
                                        whenEffect(modify3(observers, (n) => [n === 1, n - 1])),
                                        asVoid,
                                      ),
                                    ),
                                    zipRight(update2(observers, (n) => n + 1)),
                                    zipRight(
                                      scopeAddFinalizerExit(scope2, (exit3) =>
                                        pipe(
                                          sync(() => map9.delete(layer)),
                                          zipRight(get10(finalizerRef)),
                                          flatMap7((finalizer) => finalizer(exit3)),
                                        ),
                                      ),
                                    ),
                                    zipRight(
                                      deferredSucceed(deferred, exit2.effect_instruction_i0),
                                    ),
                                    as(exit2.effect_instruction_i0[1]),
                                  );
                                }
                              }
                            }),
                    ...
                    const memoized = [
                      ...
                      (exit2) =>
                        pipe(
                          get10(finalizerRef),
                          flatMap7((finalizer) => finalizer(exit2)),
                        ),
                    ];
...
var makeMemoMap = /* @__PURE__ */ suspend(() =>
  map8(makeSynchronized(new Map()), (ref) => new MemoMapImpl(ref)),
);
var unsafeMakeMemoMap = () => new MemoMapImpl(unsafeMakeSynchronized(new Map()));
var buildWithScope = /* @__PURE__ */ dual(2, (self, scope2) =>
  flatMap7(makeMemoMap, (memoMap) => buildWithMemoMap(self, memoMap, scope2)),
);
var buildWithMemoMap = /* @__PURE__ */ dual(3, (self, memoMap, scope2) =>
  flatMap7(makeBuilder(self, scope2), (run) =>
    provideService(run(memoMap), CurrentMemoMap, memoMap),
  ),
);
var makeBuilder = (self, scope2, inMemoMap = false) => {
  ...
  switch (op._op_layer) {
    ...
    case "ExtendScope": {
      return sync(
        () => (memoMap) => scopeWith((scope3) => memoMap.getOrElseMemoize(op.layer, scope3)),
      );
    }
    case "Fold": {
      return sync(
        () => (memoMap) =>
          pipe(
            memoMap.getOrElseMemoize(op.layer, scope2),
            matchCauseEffect({
    ...
    case "FromEffect": {
      return inMemoMap
        ? sync(() => (_) => op.effect)
        : sync(() => (memoMap) => memoMap.getOrElseMemoize(self, scope2));
    }
    case "Provide": {
      return sync(
        () => (memoMap) =>
          pipe(
            memoMap.getOrElseMemoize(op.first, scope2),
            flatMap7((env) =>
              pipe(memoMap.getOrElseMemoize(op.second, scope2), provideContext(env)),
            ),
          ),
      );
    }
    case "Scoped": {
      return inMemoMap
        ? sync(() => (_) => scopeExtend(op.effect, scope2))
        : sync(() => (memoMap) => memoMap.getOrElseMemoize(self, scope2));
    }
    case "Suspend": {
    ...
    case "ProvideMerge": {
      return sync(
        () => (memoMap) =>
          pipe(
            memoMap.getOrElseMemoize(op.first, scope2),
            zipWith2(memoMap.getOrElseMemoize(op.second, scope2), op.zipK),
          ),
      );
    }
    case "ZipWith": {
      return gen(function* () {
        ...
        return (memoMap) =>
          pipe(
            ...
            zipWithOptions(memoMap.getOrElseMemoize(op.second, secondScope), op.zipK, {
              concurrent: true,
            }),
          );
      });
...
var fromEffect2 = /* @__PURE__ */ dual(2, (a, b) => {
  ...
  return fromEffectContext(map8(effect, (service) => make2(tag, service)));
});
...
var scoped = /* @__PURE__ */ dual(2, (a, b) => {
  ...
  const tag = tagFirst ? a : b;
  const effect = tagFirst ? b : a;
  return scopedContext(map8(effect, (service) => make2(tag, service)));
});
...
var provide = /* @__PURE__ */ dual(2, (self, that) =>
  suspend2(() => {
...
var provideSomeLayer = /* @__PURE__ */ dual(2, (self, layer) =>
  scopedWith((scope2) =>
    flatMap7(buildWithScope(layer, scope2), (context3) => provideSomeContext(self, context3)),
  ),
);
var provideSomeRuntime = /* @__PURE__ */ dual(2, (self, rt) => {
  ...
  return uninterruptibleMask((restore) =>
    withFiberRuntime((fiber) => {
      ...
      return ensuring(
        provideSomeContext(restore(self), merge2(oldContext, rt.context)),
        withFiberRuntime((fiber2) => {
...
var console2 = /* @__PURE__ */ map8(
  /* @__PURE__ */ fiberRefGet(currentServices),
  /* @__PURE__ */ get2(consoleTag),
);
var consoleWith = (f) =>
  fiberRefGetWith(currentServices, (services) => f(get2(services, consoleTag)));
var withConsole = /* @__PURE__ */ dual(2, (effect, value) =>
  fiberRefLocallyWith(effect, currentServices, add2(consoleTag, value)),
);
var withConsoleScoped = (console3) =>
  fiberRefLocallyScopedWith(currentServices, add2(consoleTag, console3));
var setConsole = (console3) =>
  scopedDiscard(fiberRefLocallyScopedWith(currentServices, add2(consoleTag, console3)));
...
var CurrentIterationMetadata = /* @__PURE__ */ Reference2()(
...
var updateInfo = (iterationMetaRef, now, input, output) =>
  update2(iterationMetaRef, (prev) =>
    prev.recurrence === 0
      ? {
          now,
          input,
...
class ScheduleDriverImpl {
  ...
  get reset() {
    return set4(this.ref, [none2(), this.schedule.initial]).pipe(
      zipLeft(set4(this.iterationMeta, defaultIterationMetadata)),
    );
  }
  next(input) {
    return pipe(
      map8(get10(this.ref), (tuple) => tuple[1]),
      flatMap7((state) =>
        pipe(
          currentTimeMillis2,
          flatMap7((now) =>
              ...
              flatMap7(([state2, out, decision]) => {
                ...
                if (millis2 <= 0) {
                  return setState.pipe(
                    zipRight(updateInfo(this.iterationMeta, now, input, out)),
                    as(out),
                  );
                }
...
var check = /* @__PURE__ */ dual(2, (self, test) =>
  checkEffect(self, (input, out) => sync(() => test(input, out))),
);
var checkEffect = /* @__PURE__ */ dual(2, (self, test) =>
  makeWithState(self.initial, (now, input, state) =>
    flatMap7(self.step(now, input, state), ([state2, out, decision]) => {
      if (isDone4(decision)) {
        return succeed([state2, out, done5]);
      }
      return map8(test(input, out), (cont) =>
        cont ? [state2, out, decision] : [state2, out, done5],
      );
    }),
  ),
);
var driver = (self) =>
  pipe(
    make23([none2(), self.initial]),
    map8((ref) => new ScheduleDriverImpl(self, ref)),
  );
var intersect5 = /* @__PURE__ */ dual(2, (self, that) => intersectWith(self, that, intersect4));
var intersectWith = /* @__PURE__ */ dual(3, (self, that, f) =>
  makeWithState([self.initial, that.initial], (now, input, state) =>
    pipe(
      zipWith2(self.step(now, input, state[0]), that.step(now, input, state[1]), (a, b) => [a, b]),
      flatMap7(([[lState, out, lDecision], [rState, out2, rDecision]]) => {
...
var mapEffect = /* @__PURE__ */ dual(2, (self, f) =>
  makeWithState(self.initial, (now, input, state) =>
    flatMap7(self.step(now, input, state), ([state2, out, decision]) =>
      map8(f(out), (out2) => [state2, out2, decision]),
    ),
  ),
);
var passthrough = (self) =>
  makeWithState(self.initial, (now, input, state) =>
    pipe(
      ...
      map8(([state2, _, decision]) => [state2, input, decision]),
    ),
  );
var recurs = (n) => whileOutput(forever2, (out) => out < n);
var unfold2 = (initial, f) =>
  makeWithState(initial, (now, _, state) =>
    sync(() => [f(state), state, continueWith2(after2(now))]),
  );
var untilInputEffect = /* @__PURE__ */ dual(2, (self, f) =>
  checkEffect(self, (input, _) => negate(f(input))),
);
var whileInputEffect = /* @__PURE__ */ dual(2, (self, f) =>
...
var scheduleDefectRefailCause = (cause2) =>
  match2(
    find(cause2, (_) => (isDieType(_) && isScheduleDefect(_.defect) ? some2(_.defect) : none2())),
    {
      onNone: () => cause2,
      onSome: (error3) => fail(error3.error),
    },
  );
var scheduleDefectRefail = (effect) =>
  catchAllCause(effect, (cause2) => failCause(scheduleDefectRefailCause(cause2)));
var repeat_Effect = /* @__PURE__ */ dual(2, (self, schedule) =>
  repeatOrElse_Effect(self, schedule, (e, _) => fail2(e)),
);
var repeat_combined = /* @__PURE__ */ dual(2, (self, options) => {
  ...
  const withTimes = options.times
    ? intersect5(withUntil, recurs(options.times)).pipe(
        map9((intersectionPair) => intersectionPair[0]),
      )
    : withUntil;
  return scheduleDefectRefail(repeat_Effect(self, withTimes));
});
var repeatOrElse_Effect = /* @__PURE__ */ dual(3, (self, schedule, orElse2) =>
  flatMap7(driver(schedule), (driver2) =>
    matchEffect(self, {
      onFailure: (error3) => orElse2(error3, none2()),
      onSuccess: (value) =>
        repeatOrElseEffectLoop(
          provideServiceEffect(self, CurrentIterationMetadata, get10(driver2.iterationMeta)),
          driver2,
          (error3, option2) =>
            provideServiceEffect(
              orElse2(error3, option2),
...
var repeatOrElseEffectLoop = (self, driver2, orElse2, value) =>
  matchEffect(driver2.next(value), {
    onFailure: () => orDie(driver2.last),
    onSuccess: (b) =>
      matchEffect(self, {
        onFailure: (error3) => orElse2(error3, some2(b)),
        onSuccess: (value2) => repeatOrElseEffectLoop(self, driver2, orElse2, value2),
      }),
  });
var retry_Effect = /* @__PURE__ */ dual(2, (self, policy) =>
  retryOrElse_Effect(self, policy, (e, _) => fail2(e)),
);
...
var retryOrElse_Effect = /* @__PURE__ */ dual(3, (self, policy, orElse2) =>
  flatMap7(driver(policy), (driver2) =>
...
var retryOrElse_EffectLoop = (self, driver2, orElse2) => {
  return catchAll(self, (e) =>
    matchEffect(driver2.next(e), {
      onFailure: () =>
        pipe(
          driver2.last,
          orDie,
          flatMap7((out) => orElse2(e, out)),
        ),
      onSuccess: () => retryOrElse_EffectLoop(self, driver2, orElse2),
    }),
  );
};
var schedule_Effect = /* @__PURE__ */ dual(2, (self, schedule) =>
  scheduleFrom_Effect(self, undefined, schedule),
);
var scheduleFrom_Effect = /* @__PURE__ */ dual(3, (self, initial, schedule) =>
  flatMap7(driver(schedule), (driver2) =>
...
var scheduleFrom_EffectLoop = (self, initial, driver2) =>
  matchEffect(driver2.next(initial), {
    onFailure: () => orDie(driver2.last),
    onSuccess: () => flatMap7(self, (a) => scheduleFrom_EffectLoop(self, a, driver2)),
  });
var forever2 = /* @__PURE__ */ unfold2(0, (n) => n + 1);
var once2 = /* @__PURE__ */ asVoid2(/* @__PURE__ */ recurs(1));
var scheduleForked = /* @__PURE__ */ dual(2, (self, schedule) =>
  forkScoped(schedule_Effect(self, schedule)),
);

// node_modules/effect/dist/esm/internal/executionPlan.js
var withExecutionPlan = /* @__PURE__ */ dual(2, (effect, plan) =>
  suspend(() => {
    let i = 0;
    let result;
    return flatMap7(
      whileLoop({
        ...
        body: () => {
          ...
          if (result) {
            ...
            nextEffect = scheduleDefectRefail(
              retry_Effect(nextEffect, scheduleFromStep(step3, false)),
            );
          } else {
            const schedule = scheduleFromStep(step3, true);
            nextEffect = schedule
              ? scheduleDefectRefail(retry_Effect(nextEffect, schedule))
              : nextEffect;
          }
...
var complete2 = (key, exit2, entryStats, timeToLiveMillis) =>
  struct({
    _tag: "Complete",
    key,
    exit: exit2,
...
var pending2 = (key, deferred) =>
  struct({
    _tag: "Pending",
    key,
    deferred,
  });
var refreshing = (deferred, complete3) =>
  struct({
    _tag: "Refreshing",
    deferred,
    complete: complete3,
...
class MapKeyImpl {
  ...
  [symbol]() {
    return pipe(
      hash(this.current),
      combine(hash(this.previous)),
      combine(hash(this.next)),
      cached(this),
    );
  }
  [symbol2](that) {
    ...
    return (
      isMapKey(that) &&
      equals(this.current, that.current) &&
      equals(this.previous, that.previous) &&
...
var initialCacheState = () =>
  makeCacheState(empty21(), makeKeySet(), unbounded(), make11(false), 0, 0);
...
class CacheImpl {
  ...
  get(key) {
    return map8(this.getEither(key), merge3);
  }
  get cacheStats() {
    return sync(() =>
      makeCacheStats({
  ...
  getOption(key) {
    return suspend(() =>
      match2(get12(this.cacheState.map, key), {
        onNone: () => {
  ...
  set(key, value) {
    return clockWith3((clock2) =>
      sync(() => {
        ...
        const mapValue = complete2(
          makeMapKey(k),
          lookupResult,
          makeEntryStats(now),
          now + toMillis(decode(this.timeToLive(lookupResult))),
        );
        set5(this.cacheState.map, k, mapValue);
      }),
    );
      ...
      suspend(() => {
        ...
        return pipe(
          ...
          flatMap7((exit2) => {
            ...
            const value = complete2(
              makeMapKey(key),
              exit2,
              stats,
              now + toMillis(decode(this.timeToLive(exit2))),
            );
...
var unsafeMakeWith = (capacity, lookup, timeToLive) =>
  new CacheImpl(capacity, empty2(), none3, lookup, (exit2) => decode(timeToLive(exit2)));

// node_modules/effect/dist/esm/internal/query.js
var currentCache = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentCache"),
  () =>
    fiberRefUnsafeMake(
      unsafeMakeWith(
        65536,
        () =>
          map8(deferredMake(), (handle) => ({
...
var currentCacheEnabled = /* @__PURE__ */ globalValue(
  /* @__PURE__ */ Symbol.for("effect/FiberRef/currentCacheEnabled"),
  () => fiberRefUnsafeMake(false),
);
var fromRequest = (request, dataSource) =>
  flatMap7(isEffect(dataSource) ? dataSource : succeed(dataSource), (ds) =>
    fiberIdWith((id) => {
      const proxy = new Proxy(request, {});
      return fiberRefGetWith(currentCacheEnabled, (cacheEnabled) => {
        if (cacheEnabled) {
          const cached3 = fiberRefGetWith(currentCache, (cache) =>
            flatMap7(cache.getEither(proxy), (orNew) => {
              switch (orNew._tag) {
                case "Left": {
                  ...
                  return uninterruptibleMask((restore) =>
                    flatMap7(
                      exit(blocked(empty15, restore(deferredAwait(orNew.left.handle)))),
                      (exit2) => {
        ...
        listeners.increment();
        return flatMap7(deferredMake(), (ref) =>
          ensuring(
            blocked(
              single(
                ds,
...
var cacheRequest = (request, result) => {
  return fiberRefGetWith(currentCacheEnabled, (cacheEnabled) => {
    if (cacheEnabled) {
      return fiberRefGetWith(currentCache, (cache) =>
        flatMap7(cache.getEither(request), (orNew) => {
          switch (orNew._tag) {
            case "Left": {
              return void_;
            }
...
var withRequestCaching = /* @__PURE__ */ dual(2, (self, strategy) =>
  fiberRefLocally(self, currentCacheEnabled, strategy),
);
var withRequestCache = /* @__PURE__ */ dual(2, (self, cache) =>
  fiberRefLocally(self, currentCache, cache),
);
...
var withRandomFixed = /* @__PURE__ */ dual(2, (effect, values3) =>
  withRandom2(effect, fixed2(values3)),
);
...
var transposeMapOption = /* @__PURE__ */ dual(2, (self, f) =>
  isNone(self) ? succeedNone2 : map10(f(self.value), some),
);
        ...
        get() {
          if (isFunction3) {
            return function () {
              return fromEffect2(
                TagClass,
                map10(maker.effect.apply(null, arguments), (_) => new this(_)),
              );
            }.bind(this);
          }
          return (layerCache ??= fromEffect2(
            TagClass,
            map10(maker.effect, (_) => new this(_)),
          ));
        },
      });
        ...
        get() {
          if (isFunction3) {
            return function () {
              return scoped(
                TagClass,
                map10(maker.scoped.apply(null, arguments), (_) => new this(_)),
              );
            }.bind(this);
          }
          return (layerCache ??= scoped(
            TagClass,
            map10(maker.scoped, (_) => new this(_)),
          ));
        },
      });
    ...
    if (hasDeps) {
      ...
      Object.defineProperty(TagClass, "Default", {
        get() {
          ...
          return (layerWithDepsCache ??= provide(
...
function fnApply(options) {
  ...
  if (options.pipeables.length > 0) {
    try {
      ...
      effect = fnError ? failCause4(sequential(die(fnError), die(error3))) : die3(error3);
    }
  }
  let cache = false;
...
// src/main.ts
var make38 = () => {
  const program = exports_Console.log("Hello, World!");
  exports_Effect.runSync(program);
};
export { make38 as make };
